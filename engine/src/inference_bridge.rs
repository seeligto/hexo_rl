...
impl InferenceBatcher {
    #[new]
    // P3 (`docs/notes/p3_model_migration_handoff.md`): `feature_len` default
    // flips to `8 * 19 * 19` when the model migrates to `in_channels = 8`.
    // Mirror change in `engine/src/game_runner/mod.rs::SelfPlayRunner::new`.
