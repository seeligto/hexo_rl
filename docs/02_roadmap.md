...
- [~] **§175 — v6 sustained** — CLOSED 2026-05-14 at step 70176 (70% of 100K target) by V70K-4 attractor capture (100% colony-spam wins, n_components 14.90 at the §176 Phase B warning threshold). Empirical sampled-eval peak at step 20000 = 18.0% n=100 vs SealBot [11.7, 26.7]; step 70000 = 4.0%. Step-20K promoted as §176 Phase A Gate 3 anchor `checkpoints/bootstrap_model_v6_step20k.pt`. See sprint log §175 + §176 Gate 1+2+3 close-out.
- [x] **§176 — Phase A KrakenBot eval ladder validation + colony POC + step-20K anchor promotion** — CLOSED 2026-05-15. Five-wave investigation (A1–E) + three gates (Gate 1 STRENGTHEN_ONLY operator review, Gate 2 MIXED 70K tourney with critical methodology divergence note on T=0.0 vs T=0.5, Gate 3 PROMOTED step-20K weights-only artifact). Mechanism lessons L18–L23 landed (sampled-policy regression into colony attractor; eval-temperature mode change inverts checkpoint rankings; greedy 50-0 H2H = 2 effective games × 25 reps over-confident Wilson95). Phase B opens on fresh branch.
- [ ] **§176 — Phase B Source A static corpus mixing + colony POC integration + Source B design** — pending launch. Anchor `bootstrap_model_v6_step20k.pt`. S1–S6 sequence per `docs/handoffs/s176_phase_b_prompt.md`. Forward: §177+ Source B live cross-bot games (design-only this sprint).
