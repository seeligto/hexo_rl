...
- [ ] **§176 — Phase B Source A static corpus mixing + colony POC integration + Source B design** — pending launch. Anchor `bootstrap_model_v6_step20k.pt`. S1–S6 sequence per `reports/s176_phase_b_prompt.md`. Forward: §177+ Source B live cross-bot games (design-only this sprint).
