...
def test_forward_with_float16_input():
    ...
    net = make_net().half()
    x = torch.zeros(2, 24, 9, 9, dtype=torch.float16)
    log_policy, value, v_logit = net(x)
