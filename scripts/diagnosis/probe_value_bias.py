...
Run:  .venv/bin/python scripts/diagnosis/probe_value_bias.py
"""
...
def main():
    ...
    out = {
        "meta": {
            "script": "scripts/diagnosis/probe_value_bias.py",
    ...
    op = ROOT / "scripts/diagnosis/probe_value_bias_results.json"
