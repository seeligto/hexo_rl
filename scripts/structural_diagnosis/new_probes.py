...
Usage (dry-run, no engine required):
    python scripts/structural_diagnosis/new_probes.py --probe p4 --dry-run

Usage (wired, after filling integration points):
    python scripts/structural_diagnosis/new_probes.py \\
...
Retrospective validation target (§5 of the audit doc):
    for s in 10 20 30 40 50; do
      python scripts/structural_diagnosis/new_probes.py --probe p4 \\
